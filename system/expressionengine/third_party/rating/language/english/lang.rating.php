 ...
 * @version		3.3.1
 * @filesource	rating/language/english/lang.rating.php
 */
...
'no_rating_comments' =>
'No Rating Comments found.',

'rating_comments_for_id' =>
'Rating Comments for Rating ID: ',

'edit_rating_comments' =>
'Edit Rating Comment',

'no_rating_comment_submitted' =>
'No rating comment was submitted.',

"rating_comment_delete_confirm" =>
"Are you sure you want to delete %i% %rating%?",

"rating_comment_deleted" =>
"%i% rating comment deleted.",

"rating_comments_deleted" =>
"%i% rating comments deleted.",
...
"no_entry_id" =>
"Se requiere un identificador para ingresar una calificación.",

"no_rating_id_for_comment" =>
"A rating id is required to submit a comment.",

"missing_comment" =>
"No se ingresó ningun comentario.",

"not_authorized" =>
"No está autorizado para publicar calificaciones en este momento.",

"not_authorized_delete" =>
'No tiene permisos para borrar calificaciones en este momento.',

"form_already_submitted" =>
"Este formulario ya fue enviado.",
...
"no_duplicate_reviews" =>
"It appears that you have already submitted a review. Duplicate reviews are not allowed.",

"no_duplicates_rating_vote" =>
"Usted ya votó por este proyecto. No están permitidos los votos duplicadas.",

"bad_collection" =>
"%n is not an allowed collection.",

"must_be_member" =>
"Usted debe ser un miembro registrado para poder votar.",
...
"no_rating_entry_comment_id" =>
"No rating, entry, or comment ID found.",
...
'demo_description' =>
'These demonstration templates will help you understand better how the Solspace Rating Addon works.',
